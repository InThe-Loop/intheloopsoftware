		...
		<div class="container">
			...
			<div class="col-lg-8">
				...
				<div class="swiper-wrapper align-items-center">
					...
					<img src="../public/img/portfolio/portfolio-details-1.png" alt="MissVee Famous Look" />
					</div>
					<div class="swiper-slide">
					<img src="../public/img/portfolio/portfolio-details-2.png" alt="MissVee Famous Look" />
					</div>
					<div class="swiper-slide">
					<img src="../public/img/portfolio/portfolio-details-3.png" alt="MissVee Famous Look" />
					</div>
				</div>
			...
			<div class="col-lg-4">
				...
				<ul>
					...
					<li><strong>Client</strong>: Missvee Famous Look</li>
					<li><strong>Date</strong>: 01 Nov, 2022</li>
					<li><strong>URL</strong>: <a href="https://missveefamouslook.store/">missveefamouslook.store</a></li>
				</ul>
				</div>
				<div class="portfolio-description">
				<h2>Technologies used</h2>
				<p>This is one of our latest projects successfully completed. MissVee Famous Look is an e-commerce online boutique store. This was a month-long project from start to end. The technologies used are:</p>
				<ul>
					<li>Laravel 8/PHP 8</li>
					<li>VueJs</li>
					<li>Yoco Payment Gateway</li>
